...
dikey.addWidget(buton_2)                        # Buton 2'yi Dikey Ölçekte Yerleştir
buton_2.clicked.connect(Buton2)                 # Tıklandığı zaman Buton2 Fonksiyonunu Çalıştır

pencere.setLayout(dikey)                        # Pencereyi Dikey Ölçekte Çalıştır
